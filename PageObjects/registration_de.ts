...
export class Germany extends landingPage{
    ...
    public london_sub_building_0 = element(by.css("label[class*='no-wrap-clip'][for='buildingName']"));
    public london_sub_building_1 = element(by.name("buildingName"));
    public special_preferred_city = element(by.name("preferredCity"));
    ...
    public creditCardCvv_0 = element(by.css("label[class*='no-wrap-clip'][for='payment-CC-payment-method-security-code']"));
