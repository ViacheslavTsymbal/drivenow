...
var germany_pageobject_1 = require("./germany_pageobject");
var de = new germany_pageobject_1.Germany();
var regPage = (function () {
    function regPage() {
        ...
        this.uniqMail = this.helper.addTimeStamp("meetjoeb11ack+") + "@gmail.com";
